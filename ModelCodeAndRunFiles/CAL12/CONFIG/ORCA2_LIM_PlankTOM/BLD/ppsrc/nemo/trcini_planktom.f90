...
!     volumt = 0.
     ...
     &        * e3t_0(ji,jj,jk) * tmask(ji,jj,jk) *1000.
          END DO
        END DO
      END DO
!!
...
!
     ...
     &      (12.*raass*e1t(ji,jj)*e2t(ji,jj)*e3t_0(ji,jj,1))
...
!    &      1e-6*rfact*tmask(ji,jj,1)/(14.*raass*e3t_0(ji,jj,1))   & 
!!   &      * 2.
!
        ENDDO
      ENDDO
