      ...
      IF( PRESENT( prd ) ) THEN         ! depth of the partial step level
         ...
         DO jj = 1, jpjm1
            DO ji = 1, jpim1
               ...
               IF( ze3wu >= 0._wp ) THEN   ;   zhi(ji,jj) = gdept_0(ji+1,jj,iku) - ze3wu     ! i-direction: case 1
               ELSE                        ;   zhi(ji,jj) = gdept_0(ji  ,jj,iku) + ze3wu    ! -     -      case 2
               ENDIF
               IF( ze3wv >= 0._wp ) THEN   ;   zhj(ji,jj) = gdept_0(ji,jj+1,ikv) - ze3wv    ! j-direction: case 1
               ELSE                        ;   zhj(ji,jj) = gdept_0(ji,jj  ,ikv) + ze3wv    ! -     -      case 2
               ENDIF
            END DO
         END DO
         ...
         DO jj = 1, jpjm1
            DO ji = 1, jpim1
               ...
               ze3wv  = (gdept_0(ji,jj+1,ikv) - gdepw_0(ji,jj+1,ikv)) - (gdept_0(ji,jj,ikv) - gdepw_0(ji,jj,ikv))
               IF( ze3wu >= 0._wp ) THEN 
                  pgzu(ji,jj) = (gdep3w_0(ji+1,jj,iku) - ze3wu) - gdep3w_0(ji,jj,iku)
                  ...
                  pge3ru(ji,jj) = umask(ji,jj,iku)                                                                  &
                                * ( (e3w_0(ji+1,jj,iku) - ze3wu )* ( zri(ji  ,jj    ) + prd(ji+1,jj,ikum1) + 2._wp) &
                                   - e3w_0(ji  ,jj,iku)          * ( prd(ji  ,jj,iku) + prd(ji  ,jj,ikum1) + 2._wp) )  ! j: 2
               ELSE  
                  pgzu(ji,jj) = gdep3w_0(ji+1,jj,iku) - (gdep3w_0(ji,jj,iku) + ze3wu)
                  pgru(ji,jj) = umask(ji,jj,iku) * ( prd(ji+1,jj,iku) - zri(ji,jj) )   ! i: 2
                  pmru(ji,jj) = umask(ji,jj,iku) * ( prd(ji+1,jj,iku) + zri(ji,jj) )   ! i: 2
                  pge3ru(ji,jj) = umask(ji,jj,iku)                                                                  &
                                * (  e3w_0(ji+1,jj,iku)          * ( prd(ji+1,jj,iku) + prd(ji+1,jj,ikum1) + 2._wp) &
                                   -(e3w_0(ji  ,jj,iku) + ze3wu) * ( zri(ji  ,jj    ) + prd(ji  ,jj,ikum1) + 2._wp) )  ! j: 2
               ENDIF
               IF( ze3wv >= 0._wp ) THEN
                  pgzv(ji,jj) = (gdep3w_0(ji,jj+1,ikv) - ze3wv) - gdep3w_0(ji,jj,ikv) 
                  ...
                  pge3rv(ji,jj) = vmask(ji,jj,ikv)                                                                  &
                                * ( (e3w_0(ji,jj+1,ikv) - ze3wv )* ( zrj(ji,jj      ) + prd(ji,jj+1,ikvm1) + 2._wp) &
                                   - e3w_0(ji,jj  ,ikv)          * ( prd(ji,jj  ,ikv) + prd(ji,jj  ,ikvm1) + 2._wp) )  ! j: 2
               ELSE 
                  pgzv(ji,jj) = gdep3w_0(ji,jj+1,ikv) - (gdep3w_0(ji,jj,ikv) + ze3wv)
                  pgrv(ji,jj) = vmask(ji,jj,ikv) * ( prd(ji,jj+1,ikv) - zrj(ji,jj) )   ! j: 2
                  pmrv(ji,jj) = vmask(ji,jj,ikv) * ( prd(ji,jj+1,ikv) + zrj(ji,jj) )   ! j: 2
                  pge3rv(ji,jj) = vmask(ji,jj,ikv)                                                                  &
                                * (  e3w_0(ji,jj+1,ikv)          * ( prd(ji,jj+1,ikv) + prd(ji,jj+1,ikvm1) + 2._wp) &
                                   -(e3w_0(ji,jj  ,ikv) + ze3wv) * ( zrj(ji,jj      ) + prd(ji,jj  ,ikvm1) + 2._wp) )  ! j: 2
               ENDIF
            END DO
         END DO
         CALL lbc_lnk( pgru   , 'U', -1. )   ;   CALL lbc_lnk( pgrv   , 'V', -1. )   ! Lateral boundary conditions
      ...
      DO jn = 1, kjpt      !==   Interpolation of tracers at the last ocean level   ==!            !
         DO jj = 1, jpjm1
            DO ji = 1, jpim1
               ...
               ! i- direction
               IF( ze3wu >= 0._wp ) THEN      ! case 1
                  zmaxu = ze3wu / e3w_0(ji+1,jj,iku+1)
                  ! interpolated values of tracers
               ...
               ! j- direction
               IF( ze3wv >= 0._wp ) THEN      ! case 1
                  zmaxv =  ze3wv / e3w_0(ji,jj+1,ikv+1)
                  ! interpolated values of tracers
      ...
      IF( PRESENT( prd ) ) THEN         ! depth of the partial step level
         ...
         DO jj = 1, jpjm1
            DO ji = 1, jpim1
               ...
               ELSE
                 pgzui  (ji,jj) = gdep3w_0(ji+1,jj,iku) - (gdep3w_0(ji,jj,iku) - ze3wu)
                 pgrui  (ji,jj) = umask(ji,jj,iku)   * ( prd(ji+1,jj,iku) - zri(ji,jj) )      ! i: 2
                 pmrui  (ji,jj) = umask(ji,jj,iku)   * ( prd(ji+1,jj,iku) + zri(ji,jj) )      ! i: 2
                 pge3rui(ji,jj) = umask(ji,jj,iku+1)                                                                   &
                                * (  e3w_0(ji+1,jj,iku+1)          * (prd(ji+1,jj,iku) + prd(ji+1,jj,iku+1) + 2._wp)  &
                                   -(e3w_0(ji  ,jj,iku+1) + ze3wu) * (zri(ji,jj      ) + prd(ji  ,jj,iku+1) + 2._wp)  )     ! i: 2
               ENDIF
               IF( ze3wv >= 0._wp ) THEN
               ...
               ELSE
                 pgzvi  (ji,jj) = gdep3w_0(ji,jj+1,ikv) - (gdep3w_0(ji,jj,ikv) - ze3wv)
                 pgrvi  (ji,jj) = vmask(ji,jj,ikv)   * ( prd(ji,jj+1,ikv) - zrj(ji,jj) )     ! j: 2
                 pmrvi  (ji,jj) = vmask(ji,jj,ikv)   * ( prd(ji,jj+1,ikv) + zrj(ji,jj) )     ! j: 2
                 pge3rvi(ji,jj) = vmask(ji,jj,ikv+1)                                                                   &
                                * (  e3w_0(ji,jj+1,ikv+1)          * ( prd(ji,jj+1,ikv) + prd(ji,jj+1,ikv+1) + 2._wp) &
                                   -(e3w_0(ji,jj  ,ikv+1) + ze3wv) * ( zrj(ji,jj      ) + prd(ji,jj  ,ikv+1) + 2._wp) )  ! j: 2
               ENDIF
            END DO
         END DO
