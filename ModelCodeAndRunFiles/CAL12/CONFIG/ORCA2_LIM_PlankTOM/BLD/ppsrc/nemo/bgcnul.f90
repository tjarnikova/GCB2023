...
!
     ...
     &        +snkdsi(ji,jj,jk)/e3t_0(ji,jj,jk)
            zlosss=remdsi(ji,jj,jk)+snkdsi(ji,jj,jk+1)/e3t_0(ji,jj,jk)
!
...
!
     ...
     &           snkcal(ji,jj,jk+1)/e3t_0(ji,jj,jk+1))*e3t_0(ji,jj,jk+1)
               snkara(ji,jj,jk+1) = min(trn(ji,jj,jk,jpara), &
     &           snkara(ji,jj,jk+1)/e3t_0(ji,jj,jk+1))*e3t_0(ji,jj,jk+1)
          END DO
        END DO
      END DO
      RETURN
